...
Student::Student()
{
    ...
    Student::Student(string A, string B, int F, vector<int>C, int D)
    {
        firstName = A;
        lastName = B;
        ...
        grade = C;
        exam = D;
        cout<<"intended constructor "<<endl;
        res();
        med();
    ...
    void   Student::randomStudentGenerator(std::vector<Student>& students)
    {
    ...
    void   Student::randomPartiallyStudentGenerator(std::vector<Student>& students)
    {
        Student s;
        s.grade.clear();
        std::random_device rd;                          //Random number generation std based on computer hardware inbetween 1-10
    ...
    void  Student::output ()
    {   cout<<" output triggered "<<endl;
        cout << firstName << " | " << lastName << " | " << std::setprecision(2) << finalResult << " | " << std::setprecision(2) << medianResult<< std::endl;
    ...
    void generateRandomStudentInfo(std::vector<Student>& students)
    {
        Student student;
        int choice;
        cout<<"2"<<endl;
        ...
        switch (choice){
            case 1:
                Student::randomStudentGenerator(students);
                break;
            case 2:
                Student::randomPartiallyStudentGenerator(students);
                break;
            case 0:
